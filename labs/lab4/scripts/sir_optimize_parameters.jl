# scripts/sir_optimize_parameters.jl
...
save(joinpath("data", "optimization_result.jld2"), Dict("best" => best, "fitness" => fitness))
println("\nРезультаты сохранены в data/optimization_result.jld2")
